...
let animeData = [
    ...
    { id: 'spyxfamily',
     title: 'Spy x Family',
      searchName: 'spy x family',
       img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAHhzlPzhLWOCeOpWd567T-oXtxIBE6cuNkqJuHCpgig&s=10',
        video: [
    ...
    { id: 'tokyorev',
     title: 'Tokyo Revengers',
      searchName: 'tokyo revengers',
       img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqRrrecYnEfthMxwEgywUxOkQoQa9tTqM0moyb7R0gsA&s=10',
       video: [
    ...
    { id: 'cyberpunk',
     title: 'Cyberpunk: Edgerunners',
      searchName: 'cyberpunk edgerunners',
       img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShzFrYYMR2bdzA9EA2MIIGISb_xDMM6kZacfsO9bZy9g&s=10', 
      video: [
     ...
     title: 'Parasyte: The Maxim',
      searchName: 'parasyte kiseijuu',
       img: 'https://cdn.myanimelist.net/images/anime/3/73178.jpg',
         video: [
        { label: 'Trailer', url: 'Video/Parasyte.1.mp4' },
    ...
    { id: 'rezero',
     title: 'Re:Zero',
      searchName: 're zero',
       img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQsfogwAPrC--rdTfTNm-n_AXe719wBVoisscdIOGDCg&s=10',
         video: [
        { label: 'Trailer', url: 'Video/ReZero.1.mp4' },
        { label: 'حرق', url: 'Video/ReZero.2.mp4' },
    ],
    ...
    { id: 'nanatsu',
     ...
     searchName: 'nanatsu no taizai',
      img: 'https://cdn.myanimelist.net/images/anime/8/65409.jpg',
        video: [
        { label: 'Trailer', url: 'Video/Seven Deadly Sins.1.mp4' },
        { label: 'حرق', url: 'Video/Seven Deadly Sins.2.mp4' },
    ],
       releaseYear: '2014 - 2021',
    ...
    { id: 'baki',
     title: 'Baki',
      searchName: 'baki',
       img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3IndpXvpVjfmupRWo1wzuLz41KlnUUEns8mb824rcTw&s=10',
         video: [
        { label: 'Trailer', url: 'Video/Baki.1.mp4' },
    ...
    { id: 'hellsing',
     title: 'Hellsing Ultimate',
      searchName: 'hellsing ultimate',
       img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzviJ60_N1mxYtmr4bHBZN77TzlVG5lezAoNPRaPvGbQ&s=10',
         video: [
        { label: 'Trailer', url: 'Video/Hellsing Ultimate.1.mp4' },
        { label: 'حرق', url: 'Video/Hellsing Ultimate.2..mp4' },
    ],
        releaseYear: '2006 - 2012',
         episodes: '10 Episodes',
          seasons: '1 Season',
           rating: '8.3',
            studio: 'Madhouse / Graphinica',
    ...
    { id: 'ghoul',
     ...
     searchName: 'tokyo ghoul',
      img: 'https://cdn.myanimelist.net/images/anime/5/64449.jpg', 
        video: [
        { label: 'Trailer', url: 'Video/Tokyo Ghoul.1.mp4' },
        { label: 'حرق', url: 'Video/Tokyo Ghoul.2.mp4' },
    ],
    ...
    searchName: 'promised neverland',
     img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6FfuXjhy7NUAkII7wiJHdPMR6LvBBKZqxs6lUTa5WFQ&s=10',
       video: [
        { label: 'Trailer', url: 'Video/The Promised.1.mp4' },
    ...
    searchName: 'mushoku tensei jobless reincarnation',
     img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQujX0JPRamEJ5MtZC6vWntWNkkvh8ECFRAXQoIF7mVCQ&s=10',
       video: [
        { label: 'Trailer', url: 'Video/Mushoku Tensei.1.mp4' },
...

{
 ...
 { id: 'assassination',
     title: 'Assassination Classroom',
      searchName: 'assassination classroom',
       img: 'https://cdn.myanimelist.net/images/anime/5/75639.jpg',
         video: [
        { label: 'Trailer', url: 'Video/Assassination Classroom.1.mp4' },
    ...
    title: 'Berserk',
     searchName: 'berserk', 
     img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7kEwtDwMcb4X8vv3YPXlheVX6X_hm0AXRYzIhn4FN1g&s=10', 
     video: [
        { label: 'Trailer', url: 'Video/Berserk.1.mp4' },
        
    ],
     releaseYear: '1997 - 2017',
      episodes: '37+ Episodes', 
      seasons: '3 Seasons',
       rating: '8.5',
        studio: 'OLM / GEMBA',
    ...
    { id: 'blackclover',
     title: 'Black Clover',
      searchName: 'black clover',
       ...
       video: [
        { label: 'Trailer', url: 'Video/Black Clover.1.mp4' },
         { label: 'Trailer', url: 'Video/Black Clover.2.mp4' },
    ],
     ...
     title: 'Bungou Stray Dogs',
      searchName: 'bungou stray dogs',
       img: 'https://m.media-amazon.com/images/M/MV5BYzA5Y2MzNDAtZjBjZi00OTUzLWI5NDAtMTg1ODRhMmU2MGY3XkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg',
        video: [
        { label: 'Trailer', url: 'Video/Bungou Stray Dogs.1.mp4' },
        
    ],
        releaseYear: '2016 - 2023',
         episodes: '50+ Episodes',
          seasons: '5 Seasons',
           rating: '8.3',
            studio: 'Bones',
   ...
   
    {
        ...
        searchName: "hajime no ippo new challenger",
        img: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx5258-Qn6GBiSY57iT.jpg',
         video: [
        { label: 'Trailer', url: 'Video/Hajime no Ippo.1.mp4' },
        { label: 'Trailer', url: 'Video/Hajime no Ippo.2.mp4' },
    ],
        releaseYear: '2009',
    ...
    
    {
        id: 'devilscry',
        title: "Devil May Cry",
        searchName: "devil may cry",
        img: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx1726-IrpH32PVADiO.jpg',
        video: [
        { label: 'Trailer', url: 'Video/Devil May Cry.1.mp4' },
    ...
    },
    {
        ...
        title: "Monster",
        searchName: "monster",
        img: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx19-gtMC64182sm4.jpg',
         video: [
        { label: 'Trailer', url: 'Video/monster.1.mp4' },
        
    ],
        releaseYear: '2004 - 2005',
   ...
   
    {
        id: 'gachiakuta',
        title: "Gachiakuta",
        searchName: "gachiakuta",
        img: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx178025-cWJKEsZynkil.jpg',
         video: [
        { label: 'Trailer', url: 'Video/Gachiakuta.1.mp4' },
        { label: 'Trailer', url: 'Video/Gachiakuta.2.mp4' },
    ],
        releaseYear: '2025',
        episodes: '24+ Episodes',
        seasons: '1 Season',
    ...
    },
    {
        id: 'sakamotodays',
        title: "Sakamoto Days",
        searchName: "sakamoto days",
        img: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx177709-e5Qx6RlsBgD5.png',
         video: [
        { label: 'Trailer', url: 'Video/Sakamoto Days.1.mp4' },
        { label: 'Trailer', url: 'Video/Sakamoto Days.2.mp4' },
    ],
        releaseYear: '2025 - Ongoing',
        ...
        fullStory: [{ type: 'text', content: "قاتل محترف متقاعد وسمين يعود للعمل لحماية عائلته." }]
    },
...
/* =======================================================
   التعديل الجديد في دالة openAnime
   ======================================================= */
function openAnime(id) {
    ...
    // إنشاء كود الفيديو (دعم متعدد)
    let videoHTML = '';
    let videoTabsHTML = '';

    if (Array.isArray(anime.video) && anime.video.length > 0) {
        // وضع علامات التبويب (Trailer / Episode) فوق الفيديو في المنتصف
        videoTabsHTML = `
    ...
    modalBodyHTML += `
        <div class="modal-content-split">
            <div class="modal-left">
                ...
                <!-- الاسم تحت الصورة تماماً وفي نفس مستوى الفيديو -->
